											...
											content:[
                                                new sap.ui.layout.form.SimpleForm({
													...
													content:[
                                                        ...
                                                        new sap.m.Label({text:"First Name",width:"160px"}).addStyleClass('class_label_padding'),
                                                        ...
                                                        new sap.m.Label({text:"Student ID",width:"150px"}).addStyleClass('class_label_padding'),
                                                        ...
                                                        new sap.m.Label({text:"Year level",width:labelWidth}).addStyleClass('class_label_padding'),
														new sap.m.Input("BP_TYPE_EXTPARTNER",{value:"", width:TextWidth}),
														
														new sap.m.Label({text:"Course",width:labelWidth}).addStyleClass('class_label_padding'),
														new sap.m.Input("INPUT_CONTROL_INFO_SOURCE_SYS",{width:TextWidth}),
															
                                                        new sap.m.Label({text:"Parent/Guardian Name",width:labelWidth}).addStyleClass('class_label_padding'),
														new sap.m.Input("CONTROL_INFO_DEL_FLAG",{width:TextWidth}),
                                                    ]
                                                })
                                            ]
                                        })
